"use client";
// SignupContent.tsx - This component uses useSearchParams and must be wrapped in Suspense
    ...
    <div className="mt-2 space-y-1">
      {requirements.map((req, index) => (
        <motion.div
          ...
          className={`flex items-center gap-2 text-xs ${req.test ? "text-green-400" : "text-gray-400"
            }`}
        >
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mt-3 flex justify-center gap-2">
          {testimonials.map((_, index) => (
            <motion.button
              key={index}
              className={`h-1.5 w-6 rounded-full transition-colors duration-300 ${index === currentIndex ? "bg-purple-400" : "bg-gray-600"
                }`}
              whileHover={{ scale: 1.1 }}
            ...
            >
              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  <div className="relative">
                    <motion.label
                      className={`absolute left-12 z-10 transition-all duration-300 ${focusedField === "name" || nameValue
                  ...
                  <div className="relative">
                    <motion.label
                      className={`absolute left-12 z-10 transition-all duration-300 ${focusedField === "email" || emailValue
                          ? "-top-2 bg-purple-900 px-2 text-xs text-purple-300"
                          : "top-3 text-sm text-gray-400"
                        }`}
                      animate={{
                  ...
                  <div className="relative">
                    <motion.label
                      className={`absolute left-12 z-10 transition-all duration-300 ${focusedField === "password" || passwordValue
                          ? "-top-2 bg-purple-900 px-2 text-xs text-purple-300"
                          : "top-3 text-sm text-gray-400"
                        }`}
                      animate={{
                  ...
                  <div className="relative">
                    <motion.label
                      className={`absolute left-12 z-10 transition-all duration-300 ${focusedField === "confirmPassword" ||
                ...
                >
                  ...
                  <Link
                    ...
                    href={`/login${searchParams.get("redirect") && searchParams.get("plan")
